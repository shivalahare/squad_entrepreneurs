    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_type', models.CharField(choices=[('video', 'Video'), ('book', 'Book'), ('pdf', 'PDF')], max_length=10)),
                ('file', models.FileField(blank=True, null=True, upload_to='uploads/')),
                ('video_file', models.FileField(blank=True, null=True, upload_to='videos/')),
                ('video_thumbnail', models.FileField(blank=True, null=True, upload_to='images/thumbnail/')),
            ],
        ),
        migrations.CreateModel(
            name='Plan',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('plans', models.ManyToManyField(to='subscriptions.plan')),
            ],
            options={
                'ordering': ['title'],
            },
